...
function Home({ authStatus }) {
  ...
  return (
    <>
      <div className="min-h-screen flex flex-col relative overflow-hidden z-10">
        ...
        <div className="flex-1 relative">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "url('/images/white and blue minimalist good doctor youtube thumbnail.png')",
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute top-10 left-10 w-16 h-16 bg-purple-200/30 rounded-full blur-2xl animate-pulse"></div>
            <div className="absolute top-20 right-16 w-20 h-20 bg-teal-200/30 rounded-full blur-3xl animate-pulse delay-500"></div>
            <div className="absolute bottom-20 left-20 w-12 h-12 bg-indigo-200/30 rounded-full blur-2xl animate-pulse delay-1000"></div>
          </div>
      ...
      {/* Action Section */}
      <div className="relative bg-white border-t-2 border-purple-200 z-10">
        {/* Floating orbs */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-4 left-10 w-24 h-24 bg-purple-200/40 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute top-2 right-12 w-32 h-32 bg-indigo-200/30 rounded-full blur-3xl animate-pulse delay-700"></div>
        </div>
              ...
              {!authStatus ? (
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="group relative inline-flex items-center gap-3 px-8 py-4 bg-purple-600 hover:bg-purple-700 text-white font-semibold text-lg rounded-2xl shadow-xl hover:shadow-2xl hover:shadow-purple-500/25 transition-all duration-500 transform hover:scale-105"
                  >
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border-2 border-purple-200 shadow-lg">
                    ...
                    <button
                      ...
                      className="group relative inline-flex items-center gap-3 px-8 py-4 bg-teal-600 hover:bg-teal-700 text-white font-semibold text-lg rounded-2xl shadow-xl hover:shadow-2xl hover:shadow-teal-500/25 transition-all duration-500 transform hover:scale-105"
                    >
