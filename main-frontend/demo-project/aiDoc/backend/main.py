...
#     """Shared text->LLM->TTS->visemes"""
#     print(f"Processing: {text}")

#     # Prompt Gemini
#     prompt = (
#         "<YOUR NAME IS LUNA>*Speak like a female human, formal but warm, no points until asked. "
#         "Only remedies, empathetic tone. "
#         "End with: visit local doctor (if health issue).* "
#         f"{text}\n\n"
#         "Do the semantic analysis of the response and give it a label: happy, neutral, sad, concern. "
#         "Just give the label in lowercase, do not explain. Add 'EMOTION:' before the label."
#     )
...
#     # Wrap rhubarb's mouthCues for frontend compatibility
...
#     result = await process_text_input(user_text)
